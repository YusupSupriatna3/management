...
@section('content')
 ...
 <div class="box-body">
      ...
      <form action="{{ route('RMARACCNUM-cariaccountnum') }}" method="GET" class="form-horizontal">
        {{ csrf_field() }}
          ...
          <div class="form-group">
              ...
              <div class="col-md-6">
                <select id="kategori" class="form-control" disabled>
                    <option>BY ACCOUNT_NUM</option>
                </select>
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-4 control-label">ACCOUNT_NUM</label>
              <div class="col-md-6">
                <select id="accountnum" name="accountnum" class="form-control select2" placeholder="PILIH ACCOUNT_NUM">
                <option value="">PILIH ACCOUNT_NUM</option>
                  @foreach($accountnums as $ACCOUNT_NUM)
      ...
      <div class="box-header with-border">
        <h3 class="box-title"><a target="_blank" href="{{ route('export.paymentneed') }}"><button id="download" class="btn btn-success btn-sm btn-block"><span style="color: red;" class="fa fa-download" aria-hidden="true"></span> Download To Excel</button></a></h3>
      ...
      <div class="row">
        <div class="col-sm-12">
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                <th nowrap style="text-align: center;">ACCOUNT_NUM</th>
                ...
                <th nowrap style="text-align: center;">NIP_NAS</th>
