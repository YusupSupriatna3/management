...
@section('content')
 ...
 <div class="box-body">
      ...
      <form action="{{ route('RMARACCNUM-caristandardname') }}" method="GET" class="form-horizontal">
        {{ csrf_field() }}
        <div class="box-body" style="margin-right:100px;">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <select id="accountname" name="accountname" class="form-control select2" placeholder="PILIH CC">
                <option value="">PILIH CC</option>
                  @foreach($accountnames as $ACCOUNT_NAME)
