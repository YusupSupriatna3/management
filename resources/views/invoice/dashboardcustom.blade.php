...
<li class="active">Dashboard Invoice Custom</li>
@endsection
<style type="text/css">
  /*th {
  color: #FFFFFF;   
            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <div class="small-box" style="background-color: #3c8dbc;">
                        <h4 class="small-box-footer" style="color: white;font-family: serif; background-color: #ffc107;">INVOICE CUSTOM</h4>
                        <div class="inner">
                            <h4 style="color: white;font-family: serif;">INVOICE : {{ $jumcustom[0]->jumlah_custome }}</h4>
                            <h4 style="color: white;font-family: serif;">IDR {{ number_format($custom[0]->nilai_custome) }}</h4>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box" style="background-color: #3c8dbc;">
                        <h4 class="small-box-footer" style="color: white;font-family: serif; background-color: #ffc107;">INV.CUSTOM < 500JT</h4>
                        <div class="inner">
                            <h4 style="color: white;font-family: serif;">INVOICE : {{ $jumcustom[0]->jumlah_custome }}</h4>
                            <h4 style="color: white;font-family: serif;">IDR {{ number_format($custom[0]->nilai_custome) }}</h4>
                        </div>
                        ...
                        <a href="{{ route('data-invoice-manual') }}" class="small-box-footer" style="color: white;font-family: serif;">Details</a>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="small-box" style="background-color: #3c8dbc;">
                        <h4 class="small-box-footer" style="color: white;font-family: serif; background-color: #ffc107;">INVOICE CUSTOM 5X</h4>
                        <div class="inner">
                            <h4 style="color: white;font-family: serif;">INVOICE : {{ $jumcustom[0]->jumlah_custome }}</h4>
                            <h4 style="color: white;font-family: serif;">IDR {{ number_format($custom[0]->nilai_custome) }}</h4>
                        </div>
                        ...
                        <a href="{{ route('data-invoice-belum-cetak') }}" class="small-box-footer" style="color: white;font-family: serif;">Details</a>
                    </div>
                </div>
            </div>
        <!-- /.row -->
