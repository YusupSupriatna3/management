...
<li class="active"><a href="{{ route('format-pickup-invoice') }}"><u title="Klik di sini untuk format upload by excel">Format Excel</u></a></li>
@endsection
<style type="text/css">
  form .error {
  color: #ff0000;
...
<div class="row">
  <div class="col-md-6">
    <div class="box box-primary" style="background-color: #265a88;">
      ...
      <form action="{{ route('pickup-invoice') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box-body">
