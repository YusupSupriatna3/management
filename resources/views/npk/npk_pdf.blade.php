...
<body>
    <div style="margin-left:50px;margin-top:50px;">
        ...
        <table border="1px;" style="font-size: 12px;">
            ...
            <tr>
                ...
                <td>
                    ...
                    @if(!empty($datas->keterangan_download_mrc))
                        <span style="margin-left: 30px;">+ {{ $datas->keterangan_download_mrc }}</span><br>
                    @elseif(!empty($datas->keterangan_download_otc))
                        <span style="margin-left: 30px;">+ {{ $datas->keterangan_download_otc }}</span><br>
                    @else
                        <span style="margin-left: 30px;">+ {{ $datas->keterangan_download_termin }}</span><br>
                    @endif
                </td>
        ...
        <div style="text-align: center;font-size: 12px;">
            <span style="margin-right: 110px;">Mengetahui</span>
            <span style="margin-left: 100px;">Jakarta, {{ $tgl }}</span>
            <div>
                <span style="margin-right: 60px;margin-left: 50px;">OSM CDM</span>
                <span style="margin-left: 110px;margin-right: 30px;padding-left: 20px;">MANAGER AP MANAGEMENT</span>
            </div>
        </div>
        <br><br><br><br>
        <table style="font-size: 12px;">
            <tr>
                <td><u style="margin-right: 220px;margin-left: 130px;">ARDI IMAWAN</u><br><span style="margin-right: 200px;margin-left: 140px;">NIK. 670168</span></td>
                <td><u>IBNU RADHI</u><br><span style="margin-left: 5px;">NIK. 730254</span></td>
            </tr>
        </table>
        @endforeach
    </div>
