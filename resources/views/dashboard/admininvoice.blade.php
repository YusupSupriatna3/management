            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box" style="background-color: #3c8dbc;">
                        ...
                        <a href="{{ route('dashboard-invoice-custom') }}" class="small-box-footer" style="color: white;font-family: serif;">Details</a>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="small-box" style="background-color: #3c8dbc;">
                        <h4 class="small-box-footer" style="color: white;font-family: serif; background-color: #ffc107;">TAGIHAN NOL</h4>
                        <div class="inner">
                            <h4 style="color: white;font-family: serif;">INVOICE : {{ $jumcustom[0]->jumlah_custome }}</h4>
                            <h4 style="color: white;font-family: serif;">IDR {{ number_format($custom[0]->nilai_custome) }}</h4>
                        </div>
