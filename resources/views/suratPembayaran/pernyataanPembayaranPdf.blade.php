...
<head>
 ...
 <h5><center>SURAT PERNYATAAN PEMBAYARAN CUSTOMER TELKOM</center></h5>
            ...
            <tbody> 
                ...
                @foreach($data as $datas)
                    @if($datas->total_cash!=0)    
                        <tr>
                            <td style="text-align: center;" nowrap><span id="acc[]">{{ ucwords(strtolower($mgr['customer_name'])) }}</span></td>
        ...
        <span style="margin-left: 450px;">MGR ES Collection & Debt Mgt Seg {{ $mgr['segmen'] }}</span><br><br><br><br><br><br>
