...
@extends('layouts.app')
@section('dashboard')
DATA TABLE NCRM_BILLACCOUNT PERIOD NOVEMBER 2018 UNTIL NOW
@endsection
@section('content')
    <!-- Main content -->
  ...
  <div class="box-body">
      ...
      <form action="{{ route('search-cariperiode20182019') }}" method="GET" class="form-horizontal">
        {{ csrf_field() }}
      ...
      <div class="box-header with-border">
       <h3 class="box-title pull-right"><a href="{{ URL('/ncrmbillaccount/periode20182019') }}"><button id="refresh" class="btn btn-primary btn-sm btn-block"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> Refresh</button></a></h3>
      </div>
      </div>
